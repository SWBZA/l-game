Build me this game so I can play it in a Chrome browser.
...
### 7. Game Variants (Implementation notes)
While the `Classic` mode is the primary target, the specification should be structured to allow for future integration of common variants:
- **Misère:** The goal is inverted; a player wins by forcing *themselves* into a position where they cannot move.
- **Sudden Death:** Allows a player to move both neutral pieces instead of one.
- **Symmetry:** The winning move is one that makes your L-piece symmetrical to the opponent's.
- **Forced Neutral Move:** The optional neutral piece move becomes mandatory.
